...
public class SingleResoursesnotfound {
  @Test
...
//      String endpoint = c2.getContents();
      ...
      {
          j.writexcel("TestCase",15, 7, "passed");
      }
      else
      {
          j.writexcel("TestCase",15, 7, "failed");
      }
  }
}
