...
//      
//     
//      Cell c2 = sheet1.getCell(6,9);
//      String endpoint = c2.getContents();
//      System.out.println(endpoint);
//      
//      
//      Cell c3 = sheet1.getCell(1, 9);
//      String name = c3.getContents();
//      Sheet sheet4 = workbook.getSheet(2);
//      Cell c4 = sheet4.getCell(2, 9);
//      String job = c4.getContents();
	  String baseURI = j.readexcel(1, 17);
	    RestAssured.baseURI = baseURI;
	    String endpoint = j.readexcel(6,9);
	    String name = j.readexcel(1, 9);
	    String job = j.readexcel(2, 9);
      String jsonString = "{\n"
                + "    \"name\": \""+ name +"\",\n"
                + "    \"job\": \""+ job + "\"\n"
                + "}";
         ...
         System.out.println(response1.getStatusCode());
          ...
          {
              j.writexcel("Test  Cases",15, 15, "passed");
          }
          else
          {
              j.writexcel("Test Cases",15, 15, "Defect");
          }
  }
}
